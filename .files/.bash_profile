...
alias yf="sep --text \"yf begin\" && y format && sep --text \"yf end\""
alias yl="sep --text \"yl begin\" && y lint && sep --text \"yl end\""
alias yb="sep --text \"yb begin\" && y build && sep --text \"yb end\""
alias ybe="sep --text \"ybe begin\" && y build:esm && sep --text \"ybe end\""
alias yt="sep --text \"yt begin\" && y test && sep --text \"yt end\""
alias ytsc="sep --text \"ytsc begin\" && y typecheck &&sep --text \"ytsc end\""
alias yd="sep --text \"yd begin\" && y dev && sep --text \"yd end\""
alias ys="sep --text \"ys begin\" && y start && sep --text \"ys end\""
alias yyp="c;y && yp"
alias yyd="c;y && yd"
alias yys="c;y && ys"
alias yyb="c;y && yb"
alias yybe="c;y && ybe"
alias yyt="c;y && yt"
alias ydoc="sep --text \"ydoc begin\" && y docgen && sep --text \"ydoc end\""
alias yydoc="y && ydoc"
alias yapi="sep --text \"yapi begin\" && yb && y api:extract && sep --text \"yapi end\""
